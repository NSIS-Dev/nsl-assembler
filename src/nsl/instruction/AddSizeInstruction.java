 ...
 * @author Stuart
 */
public class AddSizeInstruction extends AssembleExpression {
	public static final String name = "AddSize";
	...
	public AddSizeInstruction(int returns) {
		if (!SectionInfo.in()) throw new NslContextException(EnumSet.of(NslContext.Section), name);

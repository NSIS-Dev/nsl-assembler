 ...
 * @author Stuart
 */
public class Int64FmtInstruction extends AssembleExpression {
	public static final String name = "Int64Fmt";
	 ...
	 */
	public Int64FmtInstruction(int returns) {
		if (PageExInfo.in())

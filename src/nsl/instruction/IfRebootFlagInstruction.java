...
public class IfRebootFlagInstruction extends JumpExpression {
	...
	public void assemble(Register var) throws IOException {
		...
		if (this.booleanValue) ScriptParser.writeLine("IfRebootFlag 0 +3");
		else ScriptParser.writeLine("IfRebootFlag +3");
	...
	public void assemble(Label gotoA, Label gotoB) throws IOException {
		...
		if (this.booleanValue == true) ScriptParser.writeLine("IfRebootFlag " + gotoA + " " + gotoB);
		else ScriptParser.writeLine("IfRebootFlag " + gotoB + " " + gotoA);
	}

...
public class TargetInstruction extends AssembleExpression
{
  ...
  private static final Set<String> VALID_TARGETS = new HashSet<>(Arrays.asList(
    "amd64-unicode", "x86-ansi", "x86-unicode"
  ));
  ...
  public TargetInstruction(int returns)
  {
    ...
    if (!VALID_TARGETS.contains(targetValue))
    {
      throw new NslException(String.format(
        ...
        name, targetValue, String.join(", ", VALID_TARGETS)), true);
    }
  }

...
public class IfErrorsInstruction extends JumpExpression {
	...
	public void assemble(Register var) throws IOException {
		...
		if (this.booleanValue) ScriptParser.writeLine("IfErrors 0 +3");
		else ScriptParser.writeLine("IfErrors +3");
	...
	public void assemble(Label gotoA, Label gotoB) throws IOException {
		...
		if (this.booleanValue == true) ScriptParser.writeLine("IfErrors " + gotoA + " " + gotoB);
		else ScriptParser.writeLine("IfErrors " + gotoB + " " + gotoA);
	}

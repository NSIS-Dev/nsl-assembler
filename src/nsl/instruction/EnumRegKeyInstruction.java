 ...
 * @author Stuart
 */
public class EnumRegKeyInstruction extends AssembleExpression {
	public static final String name = "EnumRegKey";
	...
	public EnumRegKeyInstruction(int returns) {
		...
		if (paramsCount != 3) throw new NslArgumentException(name, 3);
	...
	public void assemble(Register var) throws IOException {
		...
		ScriptParser.writeLine(
				name + " " + var + " " + this.rootKey + " " + varOrSubKey + " " + varOrIndex);

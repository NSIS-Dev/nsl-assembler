...
/**
 * The NSIS IfAltRegView instruction.
 *
 * @author Jan
 */
public class IfAltRegViewInstruction extends JumpExpression {
	public static final String name = "AltRegView";
	 ...
	 */
	public IfAltRegViewInstruction(int returns) {
	...
	public void assemble(Register var) throws IOException {
		...
		if (this.booleanValue) ScriptParser.writeLine("IfAltRegView 0 +3");
		else ScriptParser.writeLine("IfAltRegView +3");
	...
	public void assemble(Label gotoA, Label gotoB) throws IOException {
		...
		if (this.booleanValue == true) ScriptParser.writeLine("IfAltRegView " + gotoA + " " + gotoB);
		else ScriptParser.writeLine("IfAltRegView " + gotoB + " " + gotoA);
	}
	...
	public void assemble(ArrayList<SwitchCaseStatement> switchCases) throws IOException {
		...
		ScriptParser.writeLine("IfAltRegView" + gotoA + gotoB);
	}
}

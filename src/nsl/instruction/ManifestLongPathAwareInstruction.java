/*
 * ManifestLongPathAwareInstruction.java
 */
 ...
 * @author Jan
 */
public class ManifestLongPathAwareInstruction extends AssembleExpression {
	public static final String name = "ManifestLongPathAware";
	 ...
	 */
	public ManifestLongPathAwareInstruction(int returns) {
